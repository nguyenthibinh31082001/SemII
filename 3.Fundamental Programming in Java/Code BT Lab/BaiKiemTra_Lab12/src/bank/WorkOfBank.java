 ...
 * @author ADMIN
 */
public class WorkOfBank extends work.Work{
    ...
    public WorkOfBank(String phongBanTh, int soNhanVienTh, String capDuyet, String workId, String workName, Date startDate, Date endDate, double totalCost) {
    ...
    public void display(){
        ...
        builder.append("|\t");
        builder.append(String.format("%10s", this.soNhanVienTh));     
        builder.append("|\t");
